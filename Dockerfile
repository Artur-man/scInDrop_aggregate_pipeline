FROM ubuntu:16.04
LABEL author="artur.manukyan@umassmed.edu" description="Docker image containing all requirements for the dolphinnext/graybuck2019_scatacseq pipeline"
...
ENV PATH /opt/conda/envs/dolphinnext-scindropaggregate-1.0/bin:/usr/local/bin/dolphin-tools/:$PATH
